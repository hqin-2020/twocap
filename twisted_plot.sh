...
python3 plots.py  --symmetric_returns ${symmetric_returns} --state_dependent_xi ${state_dependent_xi} --optimize_over_ell ${optimize_over_ell} --ell_ex ${ell_ex} --alpha_z_tilde_ex ${alpha_z_tilde_ex}
